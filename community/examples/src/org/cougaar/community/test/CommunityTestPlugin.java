...
public class CommunityTestPlugin extends SimplePlugin {
  ...
  protected void setupSubscriptions() {
    ...
    result = (roles != null &&
              roles.size() == 1 &&
              roles.contains("TestExternalRole"));
    ...
    if (result == true) {
      Collection entities1 = cs.search(testCommunityName, "(Role=Member)");
      Collection entities2 = cs.search(testCommunityName, "(Role=TransportProvider)");
      Collection entities3 = cs.search(testCommunityName, "(Role=AmmoSupplyProvider)");
    ...
    while (crs.hasMoreElements()) {
      ...
      if (testNum == 1) {
        if (cr.getVerb() != null &&
          ...
          if (resp.getResultCode() == CommunityResponse.SUCCESS) {
        ...
        if (cr.getVerb() != null &&
          ...
          CommunityResponse resp = cr.getCommunityResponse();
          if (resp.getResultCode() == CommunityResponse.SUCCESS) {
            Collection myCommunities = (Collection)resp.getResponseObject();
        ...
        if (cr.getVerb() != null &&
          ...
          CommunityResponse resp = cr.getCommunityResponse();
          if (resp.getResultCode() == CommunityResponse.SUCCESS) {
            Collection agentsWithRole = (Collection)resp.getResponseObject();
        ...
        if (cr.getVerb() != null &&
          ...
          CommunityResponse resp = cr.getCommunityResponse();
          if (resp.getResultCode() == CommunityResponse.SUCCESS) {
            Collection roles = (Collection)resp.getResponseObject();
        ...
        if (cr.getVerb() != null &&
          ...
          CommunityResponse resp = cr.getCommunityResponse();
          if (resp.getResultCode() == CommunityResponse.SUCCESS) {
            communityNames = (Collection)resp.getResponseObject();
